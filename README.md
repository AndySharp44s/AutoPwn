...
## Usage
```
sudo apt update && sudo apt upgrade && sudo apt install mousepad && sudo apt install git && sudo apt install lolcat && git clone https://github.com/AndySharp44s/AutoPwn && cd AutoPwn && chmod 777 autopwn.sh && mousepad autopwn.sh && clear && echo "execute the script with ./autopwn.sh" | lolcat
```
